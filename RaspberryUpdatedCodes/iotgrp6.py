...
import requests
import json
from recognize_test import run
...
def call_detect_api(image_url,name):
    payload = {"image_url": image_url, "user_name":name}  # <-- note the list
...
if __name__ == "__main__":
    name  = run()
    up = select_best_image()
    call_detect_api(up,name)
    print(up,"---",name)
